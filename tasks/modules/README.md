...
| [`mundane-map-core`](mundane-map-core/) | 2 | Reprojection and labels; [common CRS/WKT2](../closed/G19-010-common-crs-catalog-and-wkt2-operations.md), [bounded dimensional topology](../closed/G19-011-dimensional-geometry-validity-and-topology.md), and [OGC tile matrices](../closed/G19-014-ogc-tile-matrix-set-algorithms.md) are complete |
