...
| Task | Status | Type | Depends on | Outcome |
| --- | --- | --- | --- | --- |
| [G2-001 — Symbol contract and placement profile](G2-001-symbol-contract-and-placement-profile.md) | Proposed | HITL | G1-001 | Lock symbol contracts, units, placement, rotation, and style migration. |
...
| [G6-003 — Raster requests and rendering controls](G6-003-raster-requests-and-rendering-controls.md) | Proposed | AFK | G6-002 | Add windowing, resampling, opacity, interpolation, and affine rendering. |
...
| [G7-004 — Render cache and performance acceptance](G7-004-render-cache-and-performance-acceptance.md) | Proposed | AFK | G7-003, G6-004 | Add bounded caches and record accepted Level 1 performance evidence. |

### G8 — Native and Level 1 release readiness

| Task | Status | Type | Depends on | Outcome |
| --- | --- | --- | --- | --- |
| [G8-001 — Level 1 Native Image and CI hardening](G8-001-level1-native-image-and-ci-hardening.md) | Proposed | HITL | G2-007, G3-004, G5-010, G6-005, G7-004 | Aggregate real Linux native success and diagnostic paths in CI. |
| [G8-002 — Public API, Javadocs, and examples review](G8-002-public-api-javadocs-and-examples-review.md) | Proposed | HITL | G2-006, G3-004, G5-009, G6-004, G7-004 | Review public contracts/docs and manually verify every Level 1 example. |
