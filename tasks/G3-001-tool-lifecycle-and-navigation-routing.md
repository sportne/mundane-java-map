...
ownership, focus loss, and event-dispatch-thread enforcement remain in `mundane-map-awt`.
...
- Pointer press, drag, release, move, click, wheel, and cancel events carry finite screen/map
  coordinates and relevant button/modifier data without AWT types.
