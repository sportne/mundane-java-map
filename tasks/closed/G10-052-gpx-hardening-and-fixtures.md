...
Completion evidence (2026-07-23): the approved fixture is generated by gpxpy 1.6.2, records its
Apache-2.0 tool provenance and repository BSD-3-Clause redistribution terms, and is protected by a
recorded SHA-256. The parser tests cover the closed grammar, security fixtures, exact/one-over
budgets, seeded mutations, cancellation, snapshot mutation, and cleanup precedence.
