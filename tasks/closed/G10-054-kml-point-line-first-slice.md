...
Completion evidence (2026-07-24): the published JDK-only and AWT-free KML module securely snapshots
local UTF-8 input, directly constructs hardened StAX, traverses supported containers, and exposes
ordered Point and LineString placemarks as ordinary EPSG:4326 feature records. Focused parser,
query/lifecycle, diagnostic, rendering, architecture, publication, and clean-consumer evidence passed
before closure.
