/**
 * Bounded toolkit-neutral, decode-only PNG and JPEG raster sources.
 *
 ...
 * raster-source contracts, and malformed/untrusted input is reported with stable diagnostics. This
 * module does not provide image encoding, transcoding, or metadata editing.
 */
