...
/**
 * Immutable ceilings for the approved GeoPackage profile.
 *
 ...
 */
public record GeoPackageLimits(
    ...
    public static final GeoPackageLimits DEFAULTS =
    ...
    public GeoPackageLimits {
        if (maximumInputBytes <= 0
            ...
            throw new IllegalArgumentException("GeoPackage limits are outside the approved range");
        }
    }
     ...
     */
    public GeoPackageLimits withMaximumSchemaObjects(int value) {
     ...
     * @return copied limits
     */
    public GeoPackageLimits withMaximumVmOpcodes(long value) {
        return copy(maximumSchemaObjects, value);
    }

    private GeoPackageLimits copy(int schemaObjects, long vmOpcodes) {
