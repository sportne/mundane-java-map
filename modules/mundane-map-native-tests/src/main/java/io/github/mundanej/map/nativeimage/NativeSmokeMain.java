...
/** Native Image entrypoint that exercises symbols, Shapefile, and raster image paths. */
public final class NativeSmokeMain {
    ...
    /** Runs the exact symbol, Shapefile, and raster scenarios used by the native executable. */
