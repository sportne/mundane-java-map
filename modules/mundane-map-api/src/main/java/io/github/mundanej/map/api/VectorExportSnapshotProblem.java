...
/**
 * A stable structured problem produced while constructing a detached vector-export snapshot.
 *
 * @param code non-blank stable ASCII code
 * @param context insertion-ordered immutable bounded context
 */
public record VectorExportSnapshotProblem(String code, Map<String, String> context) {
    /** Creates a problem with a stable ASCII code and insertion-ordered context. */
    public VectorExportSnapshotProblem {
